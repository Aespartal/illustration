...
@Service
public abstract class GenericServiceImplementation<T extends GenericEntityInterface> implements GenericServiceInterface<GenericEntityInterface> {
    
    @Autowired
    private GenericDaoImplementation oGenericDaoImplementation;
